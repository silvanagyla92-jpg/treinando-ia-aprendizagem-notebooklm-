...
As capturas devem evitar a exposição desnecessária de dados pessoais, informações privadas ou conteúdo que não possa ser compartilhado publicamente.

Também devem ser preservados os direitos autorais dos materiais utilizados. Quando uma fonte protegida aparecer em uma captura, a imagem deve servir apenas como evidência do processo, sem substituir a referência original.
